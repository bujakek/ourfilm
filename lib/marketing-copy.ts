...
export const marketingCopy = {
  ...
  hu: {
    ...
    hero: {
      ...
      lead: 'A vendégek beolvassák a QR-kódot, megkapják a saját tekercsüket, és fotóznak. A képeket később együtt nézitek meg.',
      create: 'Hozd létre ingyen',
      how: 'Így működik',
    ...
    how: {
      ...
      steps: [
        [
          'Hozd létre az eseményt',
          'Állítsd be, hány képet készíthetnek a vendégek, és mikor jelenjenek meg.',
        ],
        [
          'Oszd meg a QR-kódot',
          'Tedd ki az asztalokra, vagy küldd el a linket a vendégeknek.',
        ],
        [
          'A vendégek fotóznak',
          'Megnyitják a kamerát, és elkattintják a saját tekercsüket.',
        ],
      ],
    },
    qr: {
      ...
      lead: 'Tedd ki az asztalokra, a bejárathoz vagy a bárpulthoz. A vendégek beolvassák, és már fotózhatnak is.',
      label: 'Az esemény neve',
      placeholder: 'Anna & Péter',
      fallback: 'Az esemény neve',
      link: 'Megosztható link:',
      helper: 'A saját eseményedhez egyedi QR-kódot és linket kapsz.',
    ...
    reveal: {
      eyebrow: 'ELŐHÍVÁS',
      title: 'A képek maradjanak meglepetések.',
      lead: 'Te döntöd el, mikor nyíljon meg a galéria: azonnal vagy az esemény végén.',
      opened: 'Galéria megnyílt',
    ...
    faq: {
      ...
      items: [
        [
          ...
          'Nem. A QR-kód beolvasása után a kamera közvetlenül a telefon böngészőjében nyílik meg.',
        ],
        [
          'Kell regisztrálni?',
          'A vendégeknek nem. Csak a nevüket adják meg, hogy mindenki a saját tekercsét használja.',
        ],
        [
          'Hogyan készülnek a képek?',
          'A vendégek az OurFilm kamerájával, az esemény közben fotóznak. Nincs előnézet és nincs újrapróbálás.',
        ],
        [
          'Hány képet készíthet egy vendég?',
          'Te választod ki: 5, 10, 16, 24 vagy 36 képet.',
        ],
        [
          'Mikor láthatók a képek?',
          'Te döntöd el: azonnal vagy az esemény végén.',
        ],
        [
          'Ki láthatja a képeket?',
          'A galéria nem nyilvános. Szervezőként minden képet látsz, a vendégek galériáját pedig te kapcsolod be.',
        ],
        [
          'Letölthetők a képek?',
          'Igen. Az esemény képeit egyben is letöltheted, majd megoszthatod vagy kinyomtathatod őket.',
        ],
      ],
    },
    final: {
