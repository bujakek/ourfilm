...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      `Az adatkezeléshez a következő szolgáltatókat vesszük igénybe: Supabase (adatbázis és fájltárolás), Vercel (webalkalmazás és sütimentes látogatottságmérés), PostHog, Inc. (sütimentes termékanalitika és hibadiagnosztika), ${EMAIL_PROVIDER} (belépési, jogi visszaigazoló és az elkészült album letöltéséről szóló e-mailek), valamint fizetésnél ${PAYMENT_PROCESSOR.name} és ${PAYMENT_PROCESSOR.merchantOfRecord}.`,
