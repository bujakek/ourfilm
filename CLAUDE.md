...
way in September 2026 before `lib/blob-bytes.ts` existed. Rows already replaced
by our own compressed Blob restored fine on the same phone. A restored row is
