...
const sections: LegalSection[] = [
  {
    ...
    body: [
      ...
      'Az OurFilm önálló adatkezelő a házigazda fiókja, a szerződés, a fizetés, a kapcsolattartás, a szolgáltatás biztonsága és a saját látogatottságmérése tekintetében.',
  ...
  },
  {
    ...
    body: [
      ...
      'Fizetés: a Stripe munkamenet- és tranzakcióazonosítói, az összeg, pénznem és fizetési állapot. Bankkártyaszámot az OurFilm nem kap meg.',
    ],
  },
  {
    title: 'Célok és jogalapok',
    body: [
      'A házigazda fiókját, eseményét és megrendelését a szerződés teljesítéséhez kezeljük (GDPR 6. cikk (1) b)). A számlázási és számviteli adatokat jogi kötelezettség alapján kezeljük (GDPR 6. cikk (1) c)).',
  ...
  },
  {
    ...
    body: [
      `Az adatkezeléshez a következő szolgáltatókat vesszük igénybe: Supabase (adatbázis és privát fájltárolás), Vercel (webalkalmazás és sütimentes látogatottságmérés), ${EMAIL_PROVIDER} (belépési e-mailek), valamint fizetésnél ${PAYMENT_PROCESSOR.name} (fizetési szolgáltatás).`,
      ...
      'A Vercel és egyes további szolgáltatók az Egyesült Államokban vagy más EGT-n kívüli országban is kezelhetnek adatot. Ilyen továbbításnál a szolgáltató EU–USA adatvédelmi kerettagságára, európai bizottsági megfelelőségi határozatra vagy általános szerződési feltételekre támaszkodunk. A Stripe saját adatkezelési céljai — például csalásmegelőzés — tekintetében önálló adatkezelő is lehet.',
    ],
  },
  {
    ...
    body: [
      ...
      'A házigazda fiókadatait a fiók megszüntetéséig, a szerződéses igényekhez szükséges adatokat az elévülési idő végéig, a számviteli bizonylatokat pedig a jogszabályban előírt 8 évig őrizzük.',
    ],
  },
  {
