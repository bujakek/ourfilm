 ...
 *
 * **Under `/auth`, not `/admin`, and both halves of that matter.**
 *
 * `app/admin/loading.tsx` wraps every admin segment in a Suspense boundary, and
 ...
 * error, the host dropped on `/admin` with their draft still pending. Verified
 ...
 * that owns it, so an `/admin/**` path meant the auth gate answered
